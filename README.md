...
- Data Anonymising Options - (This can mean the data collected could be partially destoryed, more-so detached from the person, the data still exists, but it is no-longer tied to the individual, this would be a popular feature among privacy focussed indivduals.)
